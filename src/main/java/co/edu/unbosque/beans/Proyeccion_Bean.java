...
public void init() {
    ...
    Type type = new TypeToken<List<Proyeccion>>() {}.getType();
    try {
 ...
 * 
 * @param cine El nombre del cine donde se proyectará la película.
 * @param sala El número de sala donde se realizará la proyección.
 * @param cip El identificador único de la película que se proyectará.
 * @param fecha La fecha en la que se realizará la proyección (en formato "yyyy-MM-dd").
 * @param dias_estreno El número de días que durará la proyección en cartelera.
 * @param espectadores El número de espectadores que asistieron a la proyección.
 * @param recaudacion La cantidad de dinero recaudada en la proyección.
 */
public void crear(String cine, int sala, String cip, String fecha, int dias_estreno, int espectadores, int recaudacion) {
    if (sala < 1 || sala > 99) {
